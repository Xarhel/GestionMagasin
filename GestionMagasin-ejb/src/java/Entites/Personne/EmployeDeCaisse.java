 ...
 */
@Entity
public class EmployeDeCaisse extends Employe implements Serializable {

    @OneToMany(mappedBy = "lEmployeDeCaisse")
    private List<PanierCaisse> panierCaisses;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EmployeDeCaisse)) {
            return false;
        }
        EmployeDeCaisse other = (EmployeDeCaisse) object;
    ...
    public String toString() {
        return "Entites.PersonneEtHeritier.EmployeDeCaisse[ id=" + id + " ]";
    }
