...
public class Administrateur implements AdministrateurLocal {
    ...
    public void creerEmploye(String nom, String prenom, String login, String mdp, Date dateCreationCompte, TypeCompte typeCompte, int idMagasin, int idRayon)
    {
     ...
     if(typeCompte==TypeCompte.agentDeLivraison)
     {
         ...
         agentDeLivraisonFacade.creerAgentDeLivraison(nom, prenom, login, mdp, dateCreationCompte, typeCompte, Mag, Ray);
     }
     ...
     {
         directionFacade.creerDirection(nom, prenom, login, mdp, dateCreationCompte, typeCompte,Mag, Ray);
     }
     ...
     {
         gerantMagasinFacade.creerGerantMagasin(nom, prenom, login, mdp, dateCreationCompte, typeCompte,Mag, Ray);
     }
