...
<nav class="navbar navbar-default">
    <div class="container-fluid menu">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://localhost:8080/GestionMagasin-war/FournisseurServlet"/>Fournisseur</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="http://localhost:8080/GestionMagasin-war/FournisseurServlet">Accueil</a></li>                 
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="FournisseurServlet?action=logout">Bonjour! <%=nom%>, Déconexion <span class="glyphicon glyphicon-log-out"></span></a></li>                    
            </ul>
        </div><!--/.nav-collapse -->
    </div><!--/.container-fluid -->
</nav>
